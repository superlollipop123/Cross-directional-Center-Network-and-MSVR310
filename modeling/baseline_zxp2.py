...
class Baseline(nn.Module):
    in_planes = 2048
    # num_classes, last_stride=1, model_path, neck="bnneck", neck_feat="after", ="resnet50", pretrain_choice="imagenet"
...
class MainNet(nn.Module):
    ...
    def forward(self, inputs):
        ...
        if self.training:
            ...
            cls_score4 = fs
            # pdb.set_trace()
            return  branch_cls_scores, cls_score4, fs, gf_list  # global feature for triplet loss
        else:
            return final_feat, gf_list, bf_list
